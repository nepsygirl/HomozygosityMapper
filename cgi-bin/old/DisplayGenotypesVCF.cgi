...
use Sort::Naturally;
use lib '/www/lib';
my $baseurl='/cgi-bin/HM/DisplayGenotypesVCF.cgi?';
...
$HM->StartOutput( ($HM->{species} ne 'human'?$HM->{species}.': ':'') .qq°$HM->{project_name} - <i class="blue">$HM->{analysis_name}</i>°);
...
<INPUT TYPE="hidden" name="vcfbuild" value="$HM->{vcf}" size="10">
...
my $include_vcf='var vcfbuild='.($HM->{vcf}||0).';';
...
<A HREF="/tutorial.html#genotypesview" TARGET="doc">tutorial</A></td></tr>
	</table> 
</FORM>\n</DIV>
